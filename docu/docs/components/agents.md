...
```bash
npx github:pmaojo/gemini-cli-templates --create-agent development/frontend-developer
```
...
```bash
npx github:pmaojo/gemini-cli-templates --sandbox e2b --agent development/frontend-developer --prompt "your development task"
```
