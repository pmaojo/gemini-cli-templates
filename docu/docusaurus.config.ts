...
const config: Config = {
  ...
  url: 'https://gemini-cli-templates.vercel.app',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/pmaojo/gemini-cli-templates/tree/main/docu/',
        },
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://gemini-cli-templates.vercel.app/',
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              href: 'https://github.com/pmaojo/gemini-cli-templates/issues',
            },
          ],
        },
        {
          ...
          items: [
            {
              label: 'Contribute',
              href: 'https://github.com/pmaojo/gemini-cli-templates/blob/main/CONTRIBUTING.md',
            },
            {
              label: 'License',
              href: 'https://github.com/pmaojo/gemini-cli-templates/blob/main/LICENSE',
            },
          ],
        },
      ],
