...
- **💬 Community**: [GitHub Discussions](https://github.com/pmaojo/gemini-code-templates/discussions)
- **🐛 Issues**: [GitHub Issues](https://github.com/pmaojo/gemini-code-templates/issues)

## Stargazers over time

[![Stargazers over time](https://starchart.cc/pmaojo/gemini-code-templates.svg?variant=adaptive)](https://starchart.cc/pmaojo/gemini-code-templates)
