...
class WorkflowManager {
    ...
    async generateWorkflowHash() {
        ...
        const fullCommand = `npx github:pmaojo/gemini-cli-templates ${commandParts.join(' ')} --workflow ${encodedYaml}`;
        ...
        const componentsOnlyCommand = componentsParts.length > 0 ? 
            `npx github:pmaojo/gemini-cli-templates ${componentsParts.join(' ')}` :
