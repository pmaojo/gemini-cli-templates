        ...
        marketplaceNotice.innerHTML = `
            ...
            <div class="notice-content">
                ...
                <div class="notice-command">
                    <code>/plugin marketplace add https://github.com/pmaojo/Gemini-cli-templates</code>
                    <button class="notice-copy-btn" onclick="copyToClipboard('/plugin marketplace add https://github.com/pmaojo/Gemini-cli-templates'); event.stopPropagation();" title="Copy command">
        ...
        <div class="modal-overlay" onclick="closeComponentModal()">
            <div class="modal-content component-modal" onclick="event.stopPropagation()">
                ...
                <div class="modal-actions">
                    <a href="https://github.com/pmaojo/Gemini-cli-templates/tree/main/cli-tool/templates/${subtype === 'framework' ? `${template.language}/examples/${templateName}` : templateName}" target="_blank" class="github-folder-link">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
    ...
    └── settings.json  # Gemini settings
                        ...
                        <div class="contribute-step">
                            ...
                            <div class="step-content-contrib">
                                ...
                                <div class="step-command">
                                    <code>npx gemini-cli-templates@latest --template=your-template-name --yes</code>
                                    <button class="copy-btn" onclick="copyToClipboard('npx gemini-cli-templates@latest --template=your-template-name --yes')">Copy</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="contribute-footer">
                            <div class="help-section">
                                <h4>Need Help?</h4>
                                <p>Check <a href="https://github.com/pmaojo/Gemini-cli-templates/tree/main/cli-tool/templates" target="_blank">existing templates</a> for examples or open an issue on GitHub for guidance.</p>
                            </div>
                        </div>
                    </div>
                </div>
