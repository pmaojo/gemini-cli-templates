...
function createComponentModalHTML(component) {
    ...
    const globalAgentCommand = component.type === 'agent' ? `npx gemini-cli-templates@latest --create-agent ${componentPath}` : null;
                        ...
                        <div class="installation-section">
                            ...
                            <div class="e2b-sandbox-section">
                                ...
                                <div class="e2b-api-setup">
                                    ...
                                    <div class="command-line">
                                        <code>npx gemini-cli-templates@latest --sandbox e2b --agent=${componentPath} --prompt "your development task"</code>
                                        <button class="copy-btn" data-command="npx gemini-cli-templates@latest --sandbox e2b --agent=${componentPath} --prompt &quot;your development task&quot;" onclick="copyToClipboard(this.dataset.command)">Copy</button>
                                    </div>
                                </div>
