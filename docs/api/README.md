...
This directory contains **static files** for the Gemini CLI Templates project deployed on Vercel.
...
- **URL:** `https://gemini-cli-templates.vercel.app-templates.vercel.app/api/track-download-supabase`
...
- **URL:** `https://gemini-cli-templates.vercel.app-templates.vercel.app/api/agents.json`
...
```javascript
fetch(
  "https://gemini-cli-templates.vercel.app-templates.vercel.app/api/agents.json"
)
  .then((res) => res.json())
...
**Maintained by:** Gemini CLI Templates Team
