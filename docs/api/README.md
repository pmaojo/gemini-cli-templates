...
- **URL:** `https://gemini-cli-templates.vercel.app/api/track-download-supabase`
...
- **URL:** `https://gemini-cli-templates.vercel.app/api/agents.json`
...
```javascript
fetch(
  "https://gemini-cli-templates.vercel.app/api/agents.json"
)
  .then((res) => res.json())
