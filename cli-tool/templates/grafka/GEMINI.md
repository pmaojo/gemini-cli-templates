...
- `GEMINI_MODEL`: The default fast model (e.g., `gemini-3-flash`) used for extraction and routing.
- `GEMINI_MODEL_REASONING`: The powerful model (e.g., `gemini-3-pro`) used for complex OWL deduction and synthesis.
