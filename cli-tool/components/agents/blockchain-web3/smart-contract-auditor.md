...
description: |
  Specialist in smart contract security audits, vulnerability detection, and attack vector analysis. Identifies reentrancy, overflow, logic errors, and economic exploits. Use for pre-deployment reviews and exploit analysis.
color: red
---
