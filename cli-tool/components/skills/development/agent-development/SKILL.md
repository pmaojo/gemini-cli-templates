...
- `flash` - Gemini 2.0 Flash (balanced)
- `pro` - Gemini 2.0 Pro (most capable)
- `flash-lite` - Gemini 2.0 Flash-Lite (fast, cheap)
- `gemini-3` - Gemini 3 (next-generation reasoning)
...
| model       | Yes      | inherit/flash/pro/flash-lite/gemini-3 | inherit                  |
