---
name: skill-share
description: A skill that creates new Gemini skills and automatically shares them on Slack using Rube for seamless team collaboration and skill discovery.
...
- **Create new Gemini skills** with proper structure and metadata
...
```
When you ask Gemini to create a skill called "pdf-analyzer":
