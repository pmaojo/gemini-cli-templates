...
- Memory files: !`find . -name "GEMINI*.md" | wc -l` available memory files for knowledge integration
...
5. **Memory Updates** - Update GEMINI.md files, enhance documentation, improve workflows, strengthen knowledge base
