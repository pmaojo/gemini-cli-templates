...
- Project progress: @GEMINI.md or @README.md (if exists)
...
1. Review current documentation status:
   ...
   - Examine `GEMINI.md` and `README.md` for project-wide documentation
   - Check for and document any new lessons learned or best practices in GEMINI.md
...
4. Update GEMINI.md and README.md if necessary:
