...
class TrackingService {
    ...
    async sendToDatabase(trackingData, signal) {
        try {
            ...
            const response = await fetch('https://gemini-cli-templates.vercel.app/api/track-download-supabase', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'User-Agent': `gemini-cli-templates/${trackingData.environment?.cli_version || 'unknown'}`
                },
    ...
    async sendCommandTracking(payload) {
        ...
        try {
            const response = await fetch('https://gemini-cli-templates.vercel.app/api/track-command-usage', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'User-Agent': `gemini-cli-templates/${payload.cliVersion}`
                },
                body: JSON.stringify(payload),
