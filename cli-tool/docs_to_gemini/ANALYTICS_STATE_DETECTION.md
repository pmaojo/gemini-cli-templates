...
## Overview
This document describes how the Gemini CLI Analytics Dashboard determines and displays conversation states in real-time.
...
1. **Checks for Running Process**:
   ...
   - Returns states like: "Gemini CLI working...", "Awaiting user input...", "User typing..."
...
#### Primary Factors:
- **Running Process**: Whether there's an active Gemini CLI process
...
- `"Gemini CLI working..."` - User just sent message or recent file activity
...
// CSS class mapping
const stateClasses = {
  'Gemini CLI working...': 'status-active',
...
This system provides real-time visibility into Gemini CLI conversation states, helping users understand what's happening across all their active sessions.